...
TrinomialBSR::TrinomialBSR(std::tuple<double, double, double, double, double, double> data, int n_, bool isCall_, bool isEuro_) : n(n_), bbs(data, n_, isCall_, isEuro_),
...
std::tuple<double, double, double, double> TrinomialBSR::Pricing() {
